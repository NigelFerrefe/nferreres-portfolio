    ...
    <main className="min-h-screen p-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-muted-foreground">Portfolio theme preview</p>
            ...
            <p className="mt-2 text-lg text-primary">{profile.job_title}</p>
          </div>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Este bloque prueba <span className="text-foreground">foreground</span>,{" "}
              <span className="text-primary">primary</span>,{" "}
              <span className="text-muted-foreground">muted-foreground</span> y el{" "}
          ...
          <div className="rounded-lg border border-border bg-popover p-6 text-popover-foreground shadow-sm">
            <p className="mb-2 text-sm text-muted-foreground">Popover / Surface</p>
            <h2 className="text-xl font-semibold text-foreground">Estados y tokens</h2>
            ...
            <div className="mt-5 rounded-md border border-input bg-background p-3">
              ...
              <p className="text-sm text-muted-foreground">
                Aquí verías cómo quedan <code className="text-primary">border</code>,{" "}
